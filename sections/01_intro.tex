...
The focus is not on
domain modeling, explanatory adequacy, or normative correctness,
but on the conditions under which stable reference and accountability
can be preserved when disagreement is treated as
a persistent feature rather than a temporary obstacle.
