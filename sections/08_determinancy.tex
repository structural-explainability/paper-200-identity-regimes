...
The lower-bound result shows that fewer than nine core regimes are insufficient.
This section records a limited determinacy property for the lower-bound core.
It does not claim that every admissible carrier in every deployed system
is exhausted by these nine regimes.
It claims only that each carrier-basis pair used in the lower-bound construction
has a well-defined assignment to one core regime.

The result is deliberately limited.
Once a carrier kind and identity basis from the lower-bound core are fixed, the regime assignment is determined.
Which identity basis a real-world referent ought to use remains a matter of modeling judgment.
Additional admissible bases may require additional regimes.
...
combinations used in the nine-regime lower-bound core.
The core pairs are:
\[
\begin{array}{rcl}
...
The first three pairs are included as one-basis pairs in the lower-bound construction.
This does not assert that obligation-bearers, occurrences, or records admit no other admissible bases in richer systems.
It asserts only that the lower-bound proof requires these three core bases.
...
The core regime assignment maps that fixed pair to the regime that preserves the declared basis under the transformation behavior used in the lower-bound construction.
...
This is determinacy for the lower-bound core, not global representational determinacy.
The theorem does not decide whether a modeler has chosen the correct identity basis for a particular real-world referent.
It also does not deny that additional admissible identity bases may be needed in richer systems.
It says only that the carrier-basis pairs used in the lower-bound construction have fixed regime assignments.
...
A scope without an extension-fixed or structure-fixed basis does not specify what decomposition preserves.
A rule without a content-fixed or structure-fixed basis does not specify what refinement preserves.
A plain referent without a locus-fixed or object-fixed basis does not specify what forking preserves.
Such a carrier is not determinately assigned within the lower-bound core.
It is under-specified.

The same point generalizes beyond the three witnessed splits.
If a deployment needs to distinguish content-fixed from carrier-fixed records,
fine-grained from coarse-grained occurrences,
or legal-person from role-holder obligation-bearers,
then those bases must also be declared.
They may require additional regimes.
That possibility is outside the lower-bound core, but it is consistent with the result.
...
regime assignment is fixed for the carrier-basis pairs included in the lower-bound core.
