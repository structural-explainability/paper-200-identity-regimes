...
The witnessed split cells force the lower bound:
BF for $\LOC/\OBJ$,
AD for $\SCOPEE/\SCOPES$,
and RF for $\RULEC/\RULES$.
The remaining entries summarize the diagnostic behavior of the core profiles.
...
\begin{table}[ht]
  ...
  \caption{Classification of each regime profile over the transformation basis $\Fset$.
    ...
    Some basis differences also affect other transformation families.}
  \label{tab:master}
\end{table}
...
The witnessed split pairs carry the lower-bound work.
...
They introduce no new carrier kinds.
...
\begin{proposition}[Distinctness of the core profiles]
