...
by a separation witness in the sense of
Definition~\ref{se200.def.SeparationWitness}.
Three pairs share a reference kind and differ by identity basis:
...
The $\SCOPEE/\SCOPES$ pair is separated by $\mathrm{AD}$.
A whole-preserving decomposition may preserve the covered cases
while changing the internal scope structure.
Thus the two regimes induce distinct identity relations.
