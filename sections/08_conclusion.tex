...
disagreement.
Under explicit constraints of neutrality, stability under incompatible
extension, and the exclusion of hidden or interpretive distinctions, we have
shown that a lower bound exists on the ontological structure required to
support accountability.
Fewer than six distinct identity-and-persistence regimes
do not satisfy the neutrality and stability requirements,
while a construction with a minimal set of six such regimes is sufficient
to meet those requirements without excess structure.
...
Future work may consider extensions that introduce additional structure, or
examine how different optimization objectives yield alternative bounds.
