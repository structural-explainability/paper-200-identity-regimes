...
\begin{abstract}
  ...
  developed in Neutral Substrates~\citep{case2026neutral}.
  ...
  plain referents. Three of those kinds fix no single identity criterion.
  ...
  The three surplus regimes answer to no additional kind in the inventory.
  ...
  reappears as a hidden discriminator that persistent disagreement
  cannot hold fixed.
  ...
  The surplus regimes are the distinctions upper-ontology
  implementations may leave to the modeler, and that cannot be recovered
  under persistent disagreement without hidden discriminators.
\end{abstract}
