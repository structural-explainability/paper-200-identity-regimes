...
\hypersetup{
  pdftitle={Referential Regimes: Transformation-Invariant Identity for Neutral Substrates},
  pdfauthor={Denise M. Case},
  pdfkeywords={formal ontology, identity and persistence, neutral substrates, accountability}
}
...
\begin{abstract}
  ...
  The additional regimes correspond to distinctions
  often handled by modeling convention,
  but such conventions cannot substitute
  for regime-level identity commitments under persistent disagreement.
\end{abstract}
...
\input{sections/03_formal_setting}
\input{sections/04_reference_inventory}
\input{sections/05_algebra}
\input{sections/06_nine_regimes}
\input{sections/07_lower_bound}
\input{sections/08_determinancy}
\input{sections/09_application}
\input{sections/60_related_work}
\input{sections/70_limits}
...
\begin{thebibliography}{99}
  ...
  D.\ M.\ Case.
  \emph{Neutral Substrates: A Design Constraint for Interoperability under Persistent Interpretive Disagreement}.
  arXiv preprint \href{https://arxiv.org/abs/2601.14271}{arXiv:2601.14271}, 2026.

  \bibitem[Edwards(2010)]{edwards2011}
  P.\ N.\ Edwards.
  ...
  In \emph{Knowledge Engineering and Knowledge Management: Ontologies and the Semantic Web (EKAW 2002)},
  volume 2473 of LNCS, pages 166--181. Springer, 2002.

  \bibitem[Grieves and Vickers(2017)]{grieves2016}
  M.\ Grieves and J.\ Vickers.
  Digital twin: Mitigating unpredictable, undesirable emergent behavior in complex systems.
  In \emph{Transdisciplinary Perspectives on Complex Systems}, pages 85--113. Springer, 2017.

  \bibitem[Guarino(1999)]{guarino1998roles}
  N.\ Guarino.
  The role of identity conditions in ontology design.
  In C.\ Freksa and D.\ M.\ Mark, editors,
  \emph{Spatial Information Theory: Cognitive and Computational Foundations of Geographic Information Science (COSIT '99)},
  volume 1661 of LNCS, pages 221--234. Springer, 1999.
